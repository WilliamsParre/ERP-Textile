        ...
        <div>
            <div className="d-flex flex-wrap py-5 mb-5">
                <div className="col-12 col-lg-4 mb-5">
                    <h1>ERP Textile Industry</h1>
                </div>
                <div className="col-4 col-sm-2 col-lg-1 col-lg-2 mb-6 mb-md-2 pr-3 pr-lg-0 pl-lg-4 offset-1 Link" style={{textAlign:'left'}}>
                    <h5>Links</h5>
                ...
                <div className="col-6 col-sm-2 col-lg-2 mb-6 mb-md-2 pr-3 pr-lg-0 pl-lg-4" style={{ textAlign: 'left' }}>
                    <h5>
                    ...
                    <address>
                        ...
                        Guntur, AP., 522502<br />
                        Tel. : +91 939 239 8378<br />
                        Fax : +91 868 847 3849<br />
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-envelope" viewBox="0 0 16 16">
                            <path d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V4Zm2-1a1 1 0 0 0-1 1v.217l7 4.2 7-4.2V4a1 1 0 0 0-1-1H2Zm13 2.383-4.708 2.825L15 11.105V5.383Zm-.034 6.876-5.64-3.471L8 9.583l-1.326-.795-5.64 3.47A1 1 0 0 0 2 13h12a1 1 0 0 0 .966-.741ZM1 11.105l4.708-2.897L1 5.383v5.722Z" />
                        </svg>
                        <a href="mailto:2000031326@kluniversity.in" style={{ textDecoration: 'none' }}> erp@company.com</a>
                    </address>
                </div>
                {/* col-lg-2 mb-6 mb-md-2 pr-3 pr-lg-0 pl-lg-4 */}
                <div className="col-12 col-sm-4 col-lg-2 mb-6 mb-md-2 pr-3 pr-lg-0 pl-lg-4 align-self-center">
                    <div classNameName="text-center icons">
                        <a href="http://google.com/+" style={{padding:'5px',}}>
                        ...
                        <a href="http://www.facebook.com/profile.php?id=" style={{padding:'5px'}}>
                        ...
                        <a href="http://www.linkedin.com/in/" style={{padding:'5px'}}>
                        ...
                        <a href="http://twitter.com/" style={{padding:'5px'}}>
                        ...
                        <a href="http://youtube.com/" style={{padding:'5px'}}>
                        ...
                        <a href="mailto:2000031326@kluniversity.in" style={{padding:'5px'}}>
